...
import com.vandunxg.file_processing.auth.api.dto.request.RoleInheritanceRequest;
import com.vandunxg.file_processing.auth.api.dto.request.RoleRequest;
import com.vandunxg.file_processing.auth.api.dto.request.RoleSearchRequest;
import com.vandunxg.file_processing.auth.api.dto.response.ResourcePermissionResponse;
import com.vandunxg.file_processing.auth.api.dto.response.RoleResponse;
import com.vandunxg.file_processing.auth.api.mapper.RoleWebMapper;
...
import com.vandunxg.file_processing.auth.application.service.PermissionCatalogQueryService;
import com.vandunxg.file_processing.auth.application.service.RoleAdminCommandService;
import com.vandunxg.file_processing.auth.application.service.RoleAdminQueryService;
...
public class RoleManagementController {
  ...
  private final PermissionCatalogQueryService permissionCatalogQueryService;
  ...
  public PagingResponse<RoleResponse> list(
    ...
    PageDTO<Role> resultPage = roleAdminQueryService.search(searchQuery);
  ...
  public Response<List<String>> resources() {
    return Response.of(roleWebMapper.toResourceCodes(permissionCatalogQueryService.resources()));
  }
  ...
  public Response<List<ResourcePermissionResponse>> permissions() {
    return Response.of(
        roleWebMapper.toPermissionResponses(permissionCatalogQueryService.permissions()));
  }
  ...
  public Response<RoleResponse> detail(@PathVariable UUID roleId) {
    return Response.of(roleWebMapper.toResponse(roleAdminQueryService.detail(roleId)));
  }
  ...
  public Response<RoleResponse> create(@Valid @RequestBody RoleRequest request) {
    return Response.of(
        roleWebMapper.toResponse(
            roleAdminCommandService.create(roleWebMapper.toCreateCommand(request, actorId()))));
  }
  ...
  public Response<RoleResponse> update(
    ...
    return Response.of(
        roleWebMapper.toResponse(
            roleAdminCommandService.update(
  ...
  public Response<RoleResponse> setInheritance(@Valid @RequestBody RoleInheritanceRequest request) {
    return Response.of(
        roleWebMapper.toResponse(
            roleAdminCommandService.setInheritance(roleWebMapper.toCommand(request, actorId()))));
  }
  ...
  public Response<RoleResponse> activate(@PathVariable UUID roleId) {
    return Response.of(
        roleWebMapper.toResponse(
            roleAdminCommandService.activate(new RoleActionCommand(actorId(), roleId))));
  }
  ...
  public Response<RoleResponse> inactivate(@PathVariable UUID roleId) {
    return Response.of(
        roleWebMapper.toResponse(
            roleAdminCommandService.inactivate(new RoleActionCommand(actorId(), roleId))));
  }
  ...
  public Response<Boolean> delete(@PathVariable UUID roleId) {
    roleAdminCommandService.delete(new RoleActionCommand(actorId(), roleId));
