...
import com.vandunxg.file_processing.auth.api.mapper.UserWebMapper;
import com.vandunxg.file_processing.auth.application.query.UserSearchQuery;
import com.vandunxg.file_processing.auth.application.service.UserAdminCommandService;
import com.vandunxg.file_processing.auth.application.service.UserAdminQueryService;
...
public class UserManagementController {
  ...
  public Response<UserResponse> create(
    ...
    return Response.of(
        userWebMapper.toResponse(
            userAdminCommandService.create(
                principal.userId(),
                request.username(),
                request.email(),
                request.displayName(),
  ...
  public PagingResponse<UserResponse> list(
    ...
    PageDTO<User> resultPage = userAdminQueryService.search(searchQuery);
  ...
  public Response<UserResponse> detail(@PathVariable UUID userId) {
    return Response.of(userWebMapper.toResponse(userAdminQueryService.detail(userId)));
  }
  ...
  public Response<UserResponse> update(
    ...
    return Response.of(
        userWebMapper.toResponse(
            userAdminCommandService.update(
                principal.userId(),
                userId,
                request.email(),
                request.displayName(),
  ...
  public Response<UserResponse> disable(
    ...
    return Response.of(
        userWebMapper.toResponse(userAdminCommandService.disable(principal.userId(), userId)));
  }
  ...
  public Response<UserResponse> enable(
      @AuthenticationPrincipal AuthenticatedUser principal, @PathVariable UUID userId) {
    return Response.of(
        userWebMapper.toResponse(userAdminCommandService.enable(principal.userId(), userId)));
  }
  ...
  public Response<UserResponse> unlock(
      @AuthenticationPrincipal AuthenticatedUser principal, @PathVariable UUID userId) {
    return Response.of(
        userWebMapper.toResponse(userAdminCommandService.unlock(principal.userId(), userId)));
  }
  ...
  public void resetPassword(
    ...
    userAdminCommandService.resetTemporaryPassword(
