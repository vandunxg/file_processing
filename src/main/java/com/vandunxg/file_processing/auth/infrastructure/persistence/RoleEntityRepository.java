...
public interface RoleEntityRepository
    extends JpaRepository<RoleEntity, UUID>, RoleEntityRepositoryCustom {
  ...
  @Query(
      """
         select new com.vandunxg.file_processing.auth.infrastructure.persistence.entity.UserRoleAssociation(ur.userId, r)
         from RoleEntity r
