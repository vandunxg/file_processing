...
public class RedisEmailVerificationTokenRepository implements EmailVerificationTokenRepository {
  ...
  private final EmailVerificationTokenRedisMapper mapper;
  ...
  public EmailVerificationToken save(EmailVerificationToken token) {
    ...
    String payload = OBJECT_MAPPER.writeValueAsString(mapper.toPayload(token));
    long ttlSeconds =
  ...
  public Optional<EmailVerificationToken> findByTokenHashForUpdate(String tokenHash) {
    ...
    return Optional.of(mapper.toDomain(payload, tokenHash));
  }
