...
import com.vandunxg.file_processing.auth.infrastructure.security.CredentialVersionJwtValidator;
import com.vandunxg.file_processing.auth.infrastructure.security.MetricsJwtDecoder;
import com.vandunxg.file_processing.auth.infrastructure.security.SessionAllowListJwtValidator;
...
public class JwtConfiguration {
  ...
  JwtDecoder jwtDecoder(
      ...
      CredentialVersionCache credentialVersionCache,
    ...
    OAuth2TokenValidator<Jwt> sessionAllowList =
        new SessionAllowListJwtValidator(sessionRepository, clock);
    OAuth2TokenValidator<Jwt> credentialVersion =
        new CredentialVersionJwtValidator(credentialVersionCache, userRepository);
